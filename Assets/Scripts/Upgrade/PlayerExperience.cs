...
/// <summary>
/// 플레이어의 경험치/레벨을 관리
/// 필요 경험치 곡선은 간단한 증가식으로 제공하며, 레벨업 시 이벤트 발생
/// UI와 드래프트는 외부(예: LevelUpDraftUI)가 이 이벤트를 구독해 처리
/// </summary>
public class PlayerExperience : MonoBehaviour
{
    ...
    [SerializeField]
    private float growthFactor = 1.12f; //레벨업마다 필요 경험치 성장 계소
    ...
    /// </remarks>
    public void AddExp(float amount) //경험치 획득시 경험치 량 누적. 레벨업시 이벤트 함수 호출, 레벨 증가
    {
        if (amount <= 0.0f)
        {
            return;
